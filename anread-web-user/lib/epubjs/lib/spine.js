...
class Spine {
  ...
  unpack(_package, _navigation, resolver, canonical) {
    console.log("_navigation: ", _navigation);
    ...
    this.items.forEach(item => {
      ...
      if (tocItem != null) {
        tocItem.subitems.forEach(subitem => {
          subitem.index = index++;
          subitem.url = resolver(subitem.href, true);
          subitem.canonical = canonical(subitem.href);
          subitem.cfiBase = item.cfiBase;
          subitem.linear = "yes";
          spineItem = new _section.default(subitem, this.hooks);
          this.append(spineItem);
        });
      }
    });
