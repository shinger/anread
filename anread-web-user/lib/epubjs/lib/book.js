...
class Book {
  ...
  unpack(packaging) {
    ...
    this.loadNavigation(this.packaging).then(() => {
      ...
      this.spine.unpack(this.packaging, this.navigation, this.resolve.bind(this), this.canonical.bind(this));
    });
  ...
  section(target) {
    console.log("when did i get section?");
    return this.spine.get(target); // return this.navigation.get(target);
  }
  /**
