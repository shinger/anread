...
api[0].list[0].list.push({
    ...
    methodId: '93107e527d607f54f44f646417b4c24f',
    desc: '',
});
api[0].list[0].list.push({
    order: '2',
    deprecated: 'false',
    url: 'http://localhost:8003/categories/{id}',
    methodId: '450305b56c94fba2a53faf6d280aca2d',
    desc: '',
});
api[0].list[0].list.push({
    order: '3',
    deprecated: 'false',
    url: 'http://localhost:8003/categories',
    methodId: '024742554c973d4636ff2555051d7668',
    desc: '',
});
api[0].list[0].list.push({
    order: '4',
    deprecated: 'false',
    url: 'http://localhost:8003/categories',
    methodId: 'f54f2c53526b8b8b79b635dc9775c213',
    desc: '',
});
api[0].list.push({
    alias: 'BookController',
    order: '2',
    link: '',
    desc: '',
    list: []
...
api[0].list[1].list.push({
    ...
    methodId: '70a2ce3dce15d675560c9a176b8294dd',
    desc: '',
});
api[0].list[1].list.push({
    order: '2',
    deprecated: 'false',
    url: 'http://localhost:8003/book/list',
    methodId: '803a89455df8db9dddad7e9dcc61590f',
    desc: '',
});
api[0].list[1].list.push({
    order: '3',
    ...
    methodId: 'd18cc1da99e00cbd4a6ecbe67eb0b259',
    desc: '',
});
api[0].list[1].list.push({
    order: '4',
    deprecated: 'false',
    url: 'http://localhost:8003/book',
    methodId: '1c25e360482f4dfb96da17fd57e5df26',
    desc: '',
});
