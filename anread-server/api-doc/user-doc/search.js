...
api[0].list.push({
    alias: 'UserAnnotationController',
    order: '1',
    link: '用户标注controller',
    desc: '用户标注Controller',
    list: []
...
api[0].list[0].list.push({
    order: '1',
    deprecated: 'false',
    url: 'http://localhost:8001/user/annotation/upload',
    methodId: 'f2765a14de88e612ed569417f379e133',
    desc: '',
});
api[0].list.push({
...
api[0].list[1].list.push({
    ...
    methodId: 'f8b1c4e1fa9cd850ba0238f2066e9296',
    desc: '用户注册',
});
api[0].list[1].list.push({
    order: '2',
    ...
    methodId: '590390dc797180459c597aaf5c8e071d',
    desc: '用户登录',
});
api[0].list[1].list.push({
    order: '3',
    ...
    methodId: '2301cf245559cbb46ee64118d02ec682',
    desc: '获取用户信息',
});
api[0].list[1].list.push({
    order: '4',
    deprecated: 'false',
    url: 'http://localhost:8001/user/avatar',
    methodId: '24a22aa9b02af851a9691a42cbd0e12c',
    desc: '上传用户头像',
});
api[0].list[1].list.push({
    order: '5',
    deprecated: 'false',
    url: 'http://localhost:8001/user/reading-record',
    methodId: 'ef62bd997a08847d8c81152c76519765',
    desc: '更新用户阅读记录',
});
