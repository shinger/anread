...
api[0].list[0].list.push({
    order: '1',
    deprecated: 'false',
    url: 'http://localhost:8002/file/book',
    methodId: 'a4f2da9baa502677bb5dc050209edfb4',
    desc: '',
});
api[0].list[0].list.push({
    order: '2',
    deprecated: 'false',
    url: 'http://localhost:8002/file/image',
    methodId: 'b0faa066188d50a0e421f08e3f9bcebd',
    desc: '',
});
api[0].list[0].list.push({
    order: '3',
    deprecated: 'false',
    url: 'http://localhost:8002/file/{fileId}',
    methodId: '671712ba8f1c99732f401adb386e6706',
    desc: '',
});
